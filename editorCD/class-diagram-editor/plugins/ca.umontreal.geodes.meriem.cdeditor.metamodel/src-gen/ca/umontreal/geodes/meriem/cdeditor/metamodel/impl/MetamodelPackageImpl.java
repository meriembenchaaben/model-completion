...
public class MetamodelPackageImpl extends EPackageImpl implements MetamodelPackage {
	 ...
	 * @generated
	 */
	public EAttribute getAssociation_IsAssociation() {
	 ...
	 * @generated
	 */
	public EAttribute getAssociation_IsInheritance() {
	...
	public void createPackageContents() {
		...
		createEAttribute(associationEClass, ASSOCIATION__IS_ASSOCIATION);
		createEAttribute(associationEClass, ASSOCIATION__IS_INHERITANCE);
	...
	public void initializePackageContents() {
		...
		initEClass(associationEClass, Association.class, "Association", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAssociation_IsComposition(), ecorePackage.getEBoolean(), "isComposition", null, 0, 1,
				Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getAssociation_IsAssociation(), ecorePackage.getEBoolean(), "isAssociation", null, 0, 1,
				Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getAssociation_IsInheritance(), ecorePackage.getEBoolean(), "isInheritance", null, 0, 1,
				Association.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
